package com.betterversions.cli;

import com.betterversions.api.MigrationManager;
...
@Command(name = "betterversions", mixinStandardHelpOptions = true, version = "betterversions 1.0", description = "Migrates Minecraft source files across major versions.")
public class BetterVersionsCLI implements Callable<Integer> {

    @Parameters(index = "0", description = "The source file or directory to translate.")
    private File source;
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new BetterVersionsCLI()).execute(args);
